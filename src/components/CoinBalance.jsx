...
const CoinBalance = ({ balance, transactions }) => {
  return (
    <div className="bg-white rounded-lg shadow-md p-4">
      <div className="flex items-center justify-between mb-4">
        <h3 className="text-xl font-semibold">Your Coins</h3>
        ...
        {transactions.map((transaction, index) => (
          <motion.div
            ...
            <div className="flex items-center space-x-3">
              <div className={`p-2 rounded ${transaction.type === 'earned' ? 'bg-green-100 text-green-600' : 'bg-blue-100 text-blue-600'}`}>
            ...
            <span className={`font-medium ${transaction.type === 'earned' ? 'text-green-600' : 'text-blue-600'}`}>
