...
const features = [
  {
    ...
    title: 'College-Only Verification',
    description: 'Trade exclusively with verified students from your campus using .edu email verification.',
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    ...
    description: 'Create listings in seconds with up to 3 photos, title, price, and category.',
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    ...
    description: 'Negotiate and coordinate meetups with in-app messaging for a seamless experience.',
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    ...
    description: 'Build trust with ratings and reviews for both buyers and sellers.',
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    ...
    description: 'Find what you need with Instagram-like feeds, filters, and category browsing.',
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    ...
    description: 'No shipping hassles. Meet on campus for safe, convenient transactions.',
  },
];
